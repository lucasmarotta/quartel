...
<div class="container">
	<div class="card">
		...
		<div class="card-body">
			...
			<form:form
				action="${basePath}${hideMenu ? '/login/registra_usuario_inicial': '/usuario/cadastrar'}"
					...
					<div class="form-group">
						<div class="input-group ${status.error ? 'is-invalid':''}">
							...
							<form:input type="password" path="senha"
								class="form-control ${status.error ? 'is-invalid':''}"
								placeholder="Senha" required="true"></form:input>
						</div>
						<div class="invalid-feedback ${status.error ? 'is-invalid':''}">
					...
					<div class="form-group">
						<div class="input-group ${status.error ? 'is-invalid':''}">
							...
							<form:input type="password" path="senhaConfirma"
								class="form-control ${status.error ? 'is-invalid':''}"
								placeholder="Confirme a senha" required="true"></form:input>
						</div>
						<div class="invalid-feedback ${status.error ? 'is-invalid':''}">
