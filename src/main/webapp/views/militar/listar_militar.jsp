...
<div class="container">
	<div class="card">
		<div class="card-body">
			<h3 class="card-title">
				<span class="fa fa-male"></span> Militares
			</h3>
			<a href="${basePath}/militar/cadastrar"
				class="btn btn-secondary float-right">Cadastrar Militar</a>
		</div>
		<div class="card-body">
				...
				<tbody>
					...
					<c:forEach items="${militares}" var="militar">
						<tr>
							...
							<td class="action"><a
								href="${basePath}/militar/editar?id=${militar.getId()}"><span
